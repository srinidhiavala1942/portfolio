    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'> Noel &nbsp; <span className='sm:block hidden font-extralight shadow-card'> |  Frontend Engineer</span>
          </p>
        </Link>
        <ul className='list-none hidden sm:flex flex-row gap-10'>
          {navLinks.map((navLink) => ( // Rename the map variable to avoid conflict with imported Link
            <li
              key={navLink.id}
              className={`${
